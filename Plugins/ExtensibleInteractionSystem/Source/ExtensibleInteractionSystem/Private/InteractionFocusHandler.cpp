...
void UInteractionFocusHandler::HandleFocusGained_Implementation(UInteractorComponent* Interactor)
{
...
void UInteractionFocusHandler::HandleFocusLost_Implementation(UInteractorComponent* Interactor)
{
